...
export class OvenWidget extends BaseWidget {
  private _coilEls: SVGLineElement[] = [];
  private _windowEl: SVGRectElement | null = null;
  private _glowEl: SVGRectElement | null = null;
  private _statusDot: SVGCircleElement | null = null;
  private _tempText: SVGTextElement | null = null;
  private _runtimeLcdEl: SVGRectElement | null = null;
  private _runtimeText: SVGTextElement | null = null;
  ...
  protected render() {
    ...
    body.setAttribute('x', String(bx)); body.setAttribute('y', String(by));
    ...
    bhl.setAttribute('x', String(bx + 1)); bhl.setAttribute('y', String(by + 1));
    bhl.setAttribute('width', String(bw - 2)); bhl.setAttribute('height', '4');
    ...
    panel.setAttribute('x', String(bx + 3)); panel.setAttribute('y', String(by + 3));
    panel.setAttribute('width', String(bw - 6)); panel.setAttribute('height', String(panelH - 1));
    ...
    this._statusDot = led as SVGCircleElement;
    svg.appendChild(led);
    ...
    lcd.setAttribute('x', String(lcdX)); lcd.setAttribute('y', String(lcdY));
    lcd.setAttribute('width', String(lcdW)); lcd.setAttribute('height', String(lcdH));
    ...
    this._tempText = tempText as SVGTextElement;
    ...
    rtLcd.setAttribute('x', String(lcdX)); rtLcd.setAttribute('y', String(rtY));
    rtLcd.setAttribute('width', String(lcdW)); rtLcd.setAttribute('height', String(rtH));
    rtLcd.setAttribute('rx', '2');
    rtLcd.setAttribute('fill', '#080e08');
    rtLcd.setAttribute('stroke', '#1a331a');
    rtLcd.setAttribute('stroke-width', '0.5');
    this._runtimeLcdEl = rtLcd as SVGRectElement;
    ...
    this._runtimeText = runtimeText as SVGTextElement;
    ...
    doorInner.setAttribute('x', String(doorX + 3)); doorInner.setAttribute('y', String(doorY + 3));
    doorInner.setAttribute('width', String(doorW - 6)); doorInner.setAttribute('height', String(doorH - 6));
    ...
    win.setAttribute('x', String(winX)); win.setAttribute('y', String(winY));
    win.setAttribute('width', String(winW)); win.setAttribute('height', String(winH));
    win.setAttribute('rx', '1');
    win.setAttribute('fill', 'rgba(0,0,0,0.88)');
    win.setAttribute('stroke', '#555');
    win.setAttribute('stroke-width', '0.5');
    this._windowEl = win as SVGRectElement;
    svg.appendChild(win);

    // 창 글로우 레이어
    const glow = document.createElementNS(ns, 'rect');
    glow.setAttribute('x', String(winX)); glow.setAttribute('y', String(winY));
    glow.setAttribute('width', String(winW)); glow.setAttribute('height', String(winH));
    ...
    for (let i = 0; i < coilCount; i++) {
      ...
      coil.setAttribute('x1', String(winX + 4)); coil.setAttribute('y1', String(cy));
      coil.setAttribute('x2', String(winX + winW - 4)); coil.setAttribute('y2', String(cy));
      coil.setAttribute('stroke', '#333');
      coil.setAttribute('stroke-width', '2');
      coil.setAttribute('stroke-linecap', 'round');
      this._coilEls.push(coil as SVGLineElement);
    ...
    for (const hy of [doorY + 6, doorY + doorH - 14]) {
      ...
      hinge.setAttribute('x', String(doorX - 3)); hinge.setAttribute('y', String(hy));
      hinge.setAttribute('width', '5'); hinge.setAttribute('height', '8');
    ...
    hndl.setAttribute('x', String(handleX)); hndl.setAttribute('y', String(handleY));
    hndl.setAttribute('width', String(handleW)); hndl.setAttribute('height', String(handleH));
    ...
    hndlHL.setAttribute('x', String(handleX + 1.5)); hndlHL.setAttribute('y', String(handleY + 1.5));
    hndlHL.setAttribute('width', String(handleW - 3)); hndlHL.setAttribute('height', '3');
