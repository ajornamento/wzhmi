...
export class MetalDetectorWidget extends BaseWidget {
    ...
    updateVisuals() {
        ...
        if (this._leftLed)
            this._leftLed.setAttribute('fill', indicatorColor);
        if (this._rightLed)
            this._rightLed.setAttribute('fill', indicatorColor);
    ...
    applyColor(color) {
        if (this._leftLed)
            this._leftLed.setAttribute('fill', color);
        if (this._rightLed)
            this._rightLed.setAttribute('fill', color);
    }
    _startAlarm() {
        const animate = () => {
            this._phase += 0.08;
            ...
            if (this._glowEl)
                this._glowEl.setAttribute('opacity', String(intensity));
